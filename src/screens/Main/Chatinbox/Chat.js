...
<View style={{paddingVertical:5,}}>
  {
    ...
    ?
    <View style={{width:"50%",backgroundColor:"#28A646",top:10,bottom:10,left:"50%",padding:"2%",borderRadius:10,}}>
...
//    </View>
                    ...
                    />
                        ...
                        <View style={{height:"100%",width:"40%",backgroundColor:"transparent",justifyContent:"center"}}>
                            ...
                            <View style={{height:"100%",width:"25%",backgroundColor:"transparent",flexDirection:"row",alignItems:"center",justifyContent:"flex-end"}}>
                              ...
                              {
                                 console.log("Your MainItem is here........................",props.postid)

      await AsyncStorage.setItem('selectpostid',props.postid+'');
        await AsyncStorage.setItem('selectposttitle',props.posttitle);

 

         props.navigation.navigate('HomeDetailsScreen')
                              }
                              }>
                              <FontAwesome
               ...
               <View style={{height:window.height*0.75,width:"100%",backgroundColor:"transparent",}}>
 ...
 <KeyboardSpacer />
                 ...
                 <View style={{height:75,width:"100%",backgroundColor:"#F0F9F5",bottom:"1%",position:"absolute",borderTopColor:"darkgray",borderTopWidth:1,flexDirection:"row",}}>
